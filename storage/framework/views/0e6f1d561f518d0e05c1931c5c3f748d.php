...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($dataUser->profile_picture): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e(asset('storage/' . $dataUser->profile_picture)); ?>"
                                         alt="Profile Picture"
                                         class="img-thumbnail"
                                         width="100">
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="pegawai" <?php echo e(old('role', $dataUser->role) == 'pegawai' ? 'selected' : ''); ?>>Pegawai</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="active" <?php echo e(old('status', $dataUser->status) == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="inactive" <?php echo e(old('status', $dataUser->status) == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                            </select>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Budi\laragon-6.0-minimal\www\stefanny-pop\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>